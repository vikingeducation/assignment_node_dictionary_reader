...
function start() {
  ...
  let onSearch = data => {
    ...
    process.stdin.on("data", data => {
      ...
      switch (searchType) {
        case "1":
          search(dictionaries.loadDictionary, "exact", searchTerm);
          break;
        case "2":
          search(dictionaries.loadDictionary, "partial", searchTerm);
          break;
        case "3":
          search(dictionaries.loadDictionary, "begins", searchTerm);
          break;
        case "4":
          search(dictionaries.loadDictionary, "ends", searchTerm);
          break;
        default:
          console.log("Invalid choice");
      }
